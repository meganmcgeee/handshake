...
exports.default = [function (session) {
  ...
  _botbuilder2.default.Prompts.text(session, (0, _joinLines2.default)(results.response.entity + '? Amazing. And what are you interested in talking about today?', '(Make it easy for me: give me a comma-separated list of interests, please!)'));
}, function (session, results) {
